...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white">
        <flux:header container class="dark:bg-zinc-900 justify-between">
            ...
            <!-- Desktop User Menu -->
            <flux:dropdown position="top" align="end" icon="home">
                <flux:profile avatar="https://img.freepik.com/vector-gratis/linda-tortuga-chef-cocinando-ilustracion-dibujos-animados_138676-3230.jpg" />
